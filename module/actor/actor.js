...
export class VampireActor extends Actor {
  ...
  static async createDialog (data = {}, options = {}) {
    // Collect data
    console.log(`Metadata => `, this.metadata, data, options);
    ...
    const html = await renderTemplate('templates/sidebar/entity-create.html', {
      ...
      types: types.reduce((obj, t) => {
        const vm20DarkAgeLabel = 'vm20DarkAge.' + t[0].toUpperCase() + t.substring(1)
        obj[t] = game.i18n.has(vm20DarkAgeLabel) ? game.i18n.localize(vm20DarkAgeLabel) : t
        return obj
      }, {}),
