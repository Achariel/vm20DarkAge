...
export class CoterieActorSheet extends ActorSheet {
  ...
  static get defaultOptions () {
    return mergeObject(super.defaultOptions, {
      classes: ['vm20DarkAge', 'sheet', 'actor', 'coterie'],
      template: 'systems/vm20DarkAge/templates/actor/coterie-sheet.html',
      width: 800,
      height: 700,
      tabs: [{
  ...
  get template () {
    ...
    return 'systems/vm20DarkAge/templates/actor/coterie-sheet.html'
  }
  ...
  getData () {
    ...
    data.sheetType = `${game.i18n.localize('vm20DarkAge.Coterie')}`
  ...
  activateListeners (html) {
    ...
    html.find('.item-chat').click(ev => {
      ...
      renderTemplate('systems/vm20DarkAge/templates/actor/parts/chat-message.html', {
        name: item.data.name,
        img: item.data.img,
  ...
  getItemDefaultName (type, data) {
    if (type === 'feature') {
      return `${game.i18n.localize('vm20DarkAge.' + data.featuretype.capitalize())}`
    }
    if (type === 'power') {
      return `${game.i18n.localize('vm20DarkAge.' + data.discipline.capitalize())}`
    }
    return `${game.i18n.localize('vm20DarkAge.' + type.capitalize())}`
  }
