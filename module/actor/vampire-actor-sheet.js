...
export class VampireActorSheet extends GhoulActorSheet {
  ...
  static get defaultOptions () {
    return mergeObject(super.defaultOptions, {
      classes: ['vm20DarkAge', 'sheet', 'actor', 'vampire'],
      template: 'systems/vm20DarkAge/templates/actor/vampire-sheet.html',
      width: 800,
      height: 700,
      tabs: [{
  ...
  get template () {
    ...
    return 'systems/vm20DarkAge/templates/actor/vampire-sheet.html'
  }
  ...
  getData () {
    ...
    data.sheetType = `${game.i18n.localize('vm20DarkAge.Vampire')}`
