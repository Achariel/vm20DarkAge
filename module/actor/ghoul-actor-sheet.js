...
export class GhoulActorSheet extends MortalActorSheet {
  ...
  static get defaultOptions () {
    return mergeObject(super.defaultOptions, {
      classes: ['vm20DarkAge', 'sheet', 'actor', 'ghoul'],
      template: 'systems/vm20DarkAge/templates/actor/ghoul-sheet.html',
      width: 800,
      height: 700,
      tabs: [{
  ...
  get template () {
    ...
    return 'systems/vm20DarkAge/templates/actor/ghoul-sheet.html'
  }
  ...
  getData () {
    ...
    data.sheetType = `${game.i18n.localize('vm20DarkAge.Ghoul')}`
  ...
  _onShowDiscipline (event) {
    ...
    const template = `
      <form>
          <div class="form-group">
              <label>${game.i18n.localize('vm20DarkAge.SelectDiscipline')}</label>
    ...
    buttons = {
      draw: {
        ...
        label: game.i18n.localize('vm20DarkAge.Add'),
        callback: async (html) => {
    ...
    new Dialog({
      title: game.i18n.localize('vm20DarkAge.AddDiscipline'),
      content: template,
      buttons: buttons,
      default: 'draw'
    }).render(true)
