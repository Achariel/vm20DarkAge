...
Hooks.once('init', async function () {
  ...
  game.settings.register('vm20DarkAge', 'worldVersion', {
    name: 'World Version',
  ...
  game.settings.register('vm20DarkAge', 'useChatRoller', {
    name: 'Chat Roller',
  ...
  game.settings.register('vm20DarkAge', 'chatRollerSortAbilities', {
  ...
  Actors.registerSheet('vm20DarkAge', VampireActorSheet, {
    label: 'Vampire Sheet',
    types: ['vampire', 'character'],
    makeDefault: true
  })
  Actors.registerSheet('vm20DarkAge', GhoulActorSheet, {
    label: 'Ghoul Sheet',
    types: ['ghoul'],
    makeDefault: true
  })
  Actors.registerSheet('vm20DarkAge', MortalActorSheet, {
    label: 'Mortal Sheet',
    types: ['mortal'],
    makeDefault: true
  })
  Actors.registerSheet('vm20DarkAge', CoterieActorSheet, {
    label: 'Coterie Sheet',
    types: ['coterie'],
    makeDefault: true
  })
  Items.unregisterSheet('core', ItemSheet)
  Items.registerSheet('vm20DarkAge', VampireItemSheet, {
    label: 'Item Sheet',
    makeDefault: true
  })
  ...
  Handlebars.registerHelper('generateFeatureLabel', function (str) {
    return 'vm20DarkAge.'.concat(capitalize(str))
  })

  Handlebars.registerHelper('generateSkillLabel', function (str) {
    return 'vm20DarkAge.'.concat(str.split(' ').flatMap(word => capitalize(word)).join(''))
  })
  ...
  Handlebars.registerHelper('sortAbilities', function (unordered = {}) {
    if (!game.settings.get('vm20DarkAge', 'chatRollerSortAbilities')) {
      return unordered
    }
  ...
  Handlebars.registerHelper('getDisciplineName', function (key, roll = false) {
    const disciplines = {
      animalism: 'vm20DarkAge.Animalism',
      auspex: 'vm20DarkAge.Auspex',
      celerity: 'vm20DarkAge.Celerity',
      dominate: 'vm20DarkAge.Dominate',
      fortitude: 'vm20DarkAge.Fortitude',
      obfuscate: 'vm20DarkAge.Obfuscate',
      potence: 'vm20DarkAge.Potence',
      presence: 'vm20DarkAge.Presence',
      protean: 'vm20DarkAge.Protean',
      sorcery: 'vm20DarkAge.BloodSorcery',
      oblivion: 'vm20DarkAge.Oblivion',
      alchemy: 'vm20DarkAge.ThinBloodAlchemy',
      rituals: 'vm20DarkAge.Rituals',
      ceremonies: 'vm20DarkAge.Ceremonies'
    }
    if (roll) {
      if (key === 'rituals') {
...
Hooks.once('diceSoNiceReady', (dice3d) => {
  dice3d.addSystem({ id: 'vm20DarkAge', name: 'vm20DarkAge' }, true)
  dice3d.addDicePreset({
    type: 'dv',
    labels: [
      'systems/vm20DarkAge/img/normal-fail-dsn.png',
      'systems/vm20DarkAge/img/normal-fail-dsn.png',
      'systems/vm20DarkAge/img/normal-fail-dsn.png',
      'systems/vm20DarkAge/img/normal-fail-dsn.png',
      'systems/vm20DarkAge/img/normal-fail-dsn.png',
      'systems/vm20DarkAge/img/normal-success-dsn.png',
      'systems/vm20DarkAge/img/normal-success-dsn.png',
      'systems/vm20DarkAge/img/normal-success-dsn.png',
      'systems/vm20DarkAge/img/normal-success-dsn.png',
      'systems/vm20DarkAge/img/normal-crit-dsn.png'
    ],
    colorset: 'black',
    fontScale: 0.5,
    system: 'vm20DarkAge'
  ...
  dice3d.addDicePreset({
    type: 'dh',
    labels: [
      'systems/vm20DarkAge/img/bestial-fail-dsn.png',
      'systems/vm20DarkAge/img/red-fail-dsn.png',
      'systems/vm20DarkAge/img/red-fail-dsn.png',
      'systems/vm20DarkAge/img/red-fail-dsn.png',
      'systems/vm20DarkAge/img/red-fail-dsn.png',
      'systems/vm20DarkAge/img/red-success-dsn.png',
      'systems/vm20DarkAge/img/red-success-dsn.png',
      'systems/vm20DarkAge/img/red-success-dsn.png',
      'systems/vm20DarkAge/img/red-success-dsn.png',
      'systems/vm20DarkAge/img/red-crit-dsn.png'
    ],
    colorset: 'hunger',
    system: 'vm20DarkAge'
  })
...
Hooks.on('renderSidebarTab', (app, html) => {
  if (!game.settings.get('vm20DarkAge', 'useChatRoller')) {
    return
  }

  const $chatForm = html.find('#chat-form')
  const template = 'systems/vm20DarkAge/templates/ui/tray.html'
...
Hooks.on('getChatLogEntryContext', function (html, options) {
  options.push({
    name: game.i18n.localize('vm20DarkAge.WillpowerReroll'),
...
async function createVampireMacro (data, slot) {
  ...
  const command = `game.vm20DarkAge.rollItemMacro("${item.name}");`
  ...
  if (!macro) {
    macro = await Macro.create({
      ...
      img: item.img,
      command: command,
      flags: { 'vm20DarkAge.itemMacro': true }
    })
  }
